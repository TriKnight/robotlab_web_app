...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'catkin_tools_prebuild' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robotlab/web-app/robotlab_web_app/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/robotlab/web-app/robotlab_web_app/install/lib;/home/robotlab/catkin_ws_melodic/devel/lib;/home/robotlab/catkin_ws/devel/lib;/opt/ros/melodic/lib)
